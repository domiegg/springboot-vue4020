	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="派送状态" prop="paisongzhuangtai">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="派送状态" prop="paisongzhuangtai">
					<el-input v-model="ruleForm.paisongzhuangtai"
						placeholder="派送状态" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="派送时间" prop="paisongshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.paisongshijian" 
						type="datetime"
						:readonly="ro.paisongshijian"
						placeholder="派送时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.paisongshijian" label="派送时间" prop="paisongshijian">
					<el-input v-model="ruleForm.paisongshijian" placeholder="派送时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'" label="派送员账号" prop="paisongyuanzhanghao">
					<el-select :disabled="ro.paisongyuanzhanghao" @change="paisongyuanzhanghaoChange" v-model="ruleForm.paisongyuanzhanghao" placeholder="请选择派送员账号">
						<el-option
							v-for="(item,index) in paisongyuanzhanghaoOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.paisongyuanzhanghao" label="派送员账号" prop="paisongyuanzhanghao">
					<el-input v-model="ruleForm.paisongyuanzhanghao" placeholder="派送员账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="派送员姓名" prop="paisongyuanxingming">
					<el-input v-model="ruleForm.paisongyuanxingming" placeholder="派送员姓名" clearable  :readonly="ro.paisongyuanxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="派送员姓名" prop="paisongyuanxingming">
					<el-input v-model="ruleForm.paisongyuanxingming" placeholder="派送员姓名" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="派送路线" prop="paisongluxian">
					<el-select :disabled="ro.paisongluxian" v-model="ruleForm.paisongluxian" placeholder="请选择派送路线" >
						<el-option
							v-for="(item,index) in paisongluxianOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="派送路线" prop="paisongluxian">
					<el-input v-model="ruleForm.paisongluxian"
						placeholder="派送路线" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="派送信息" prop="paisongxinxi">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.paisongxinxi" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.paisongxinxi" label="派送信息" prop="paisongxinxi">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.paisongxinxi"></span>
                </el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				...
				paisongxinxi : false,
				paisongshijian : false,
				paisongyuanzhanghao : false,
				paisongyuanxingming : false,
				paisongluxian : false,
				crossuserid : false,
				crossrefid : false,
				sfsh : false,
			...
			paisongyuanzhanghaoOptions: [],
			paisongluxianOptions: [],
	...
	created() {
		this.ruleForm.paisongshijian = this.getCurDateTime()
	},
	methods: {
		// 打开坐标定位窗口
		openMapDiolag () {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='paisongxinxi'){
							this.ruleForm.paisongxinxi = obj[o];
							this.ro.paisongxinxi = true;
							continue;
						}
						if(o=='paisongshijian'){
							this.ruleForm.paisongshijian = obj[o];
							this.ro.paisongshijian = true;
							continue;
						}
						if(o=='paisongyuanzhanghao'){
							this.ruleForm.paisongyuanzhanghao = obj[o];
							this.ro.paisongyuanzhanghao = true;
							continue;
						}
						if(o=='paisongyuanxingming'){
							this.ruleForm.paisongyuanxingming = obj[o];
							this.ro.paisongyuanxingming = true;
							continue;
						}
						if(o=='paisongluxian'){
							this.ruleForm.paisongluxian = obj[o];
							this.ro.paisongluxian = true;
							continue;
						}
						if(o=='crossuserid'){
			...
			this.$http({
				...
				if (data && data.code === 0) {
					var json = data.data;
					if(((json.paisongyuanzhanghao!=''&&json.paisongyuanzhanghao) || json.paisongyuanzhanghao==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.paisongyuanzhanghao = json.paisongyuanzhanghao
						this.ro.paisongyuanzhanghao = true;
					}
					if(((json.paisongyuanxingming!=''&&json.paisongyuanxingming) || json.paisongyuanxingming==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.paisongyuanxingming = json.paisongyuanxingming
						this.ro.paisongyuanxingming = true;
					}
				} else {
            ...
            this.paisongzhuangtaiOptions = "已签收,派送中".split(',')
            this.$http({
				url: `option/paisongyuan/paisongyuanzhanghao`,
				method: "get"
            }).then(({ data }) => {
				if (data && data.code === 0) {
					this.paisongyuanzhanghaoOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
            this.$http({
				...
				if (data && data.code === 0) {
					this.paisongluxianOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
			...
			// 下二随
			paisongyuanzhanghaoChange () {
				this.$http({
					url: `follow/paisongyuan/paisongyuanzhanghao?columnValue=`+ this.ruleForm.paisongyuanzhanghao,
					method: "get"
				}).then(({ data }) => {
					if (data && data.code === 0) {
						if(data.data.paisongyuanxingming){
							this.ruleForm.paisongyuanxingming = data.data.paisongyuanxingming
						}
					} else {
						this.$message.error(data.msg);
					}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.paisongxinxi = this.ruleForm.paisongxinxi.replace(reg,'../../../springboot6c5n0906/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `kuaidipeisong/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.kuaidipeisongCrossAddOrUpdateFlag = false;
											this.parent.search();
